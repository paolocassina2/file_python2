...
testo="ciao mi chiamo francescoe ho"
conta1=-1
lista_spazi=[]
for x in testo:
	conta1=conta1+1
...
for x in testo1:
	print()
	conta=conta+1
	diz[x]=lettere[lettere.index(x)+cifratura]#quando codifico  aggiungo lettera successiva-->+1. quando decodifico -1
	# ~ diz=diz+[str(x):"ciao"]
print(diz)
codifica=""
for x in testo1:
...
for jj in codifica:
	# ~ print()
	conta1=conta1+1
	diz1[jj]=lettere[lettere.index(jj)-cifratura]#quando codifico  aggiungo lettera successiva-->+1. quando decodifico -1
	# ~ diz=diz+[str(x):"ciao"]
print(diz1)
decodifica=""
for x in codifica:
	decodifica=decodifica+diz1[x]
print("decodifica ",decodifica)
# ~ for xu in codifica:
# ~ for x in testo1:
