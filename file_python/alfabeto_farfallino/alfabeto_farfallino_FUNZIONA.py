...
print("non ü proprio l alfabeto farfallino, ci assomiglia e basta")
print("funziona correttamente solo con parole aventi solamente sillabe di due lettere se finisocno per vocale (esempio:modena) o con sillabe di una lettera(es:baule)")		
