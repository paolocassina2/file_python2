#sposta files che si chiamano try o prova nella cartella prova
...
for x in listafiles:
		...
		if "try" in str(x) or "prova" in str(x) :	#e meglio che il nome del file sia sempre più lungo del nome della cartelal in modo da dare i nomi a file e cartelle sempre allo stesso mdoo
			print(str(x))		
