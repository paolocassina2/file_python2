...
def naviga_tra_i_file():
		...
		while True:
					...
					inp =input("scrivi NOME CARTELLA oppure 'ordina' per ordinare la cartella OPPURE scrivi cd.. per tornare indietro nel path OPPURE break per interrompere il programma	")
					# ~ print(path.var)
...
# ~ print(conta.var)
					...
					# ~ elif inp=="":
							# ~ continue
					#risco una cartella che non esiste , non avanza nel path,rimane dov era
						# ~ path.var=path.var
						# ~ print("abcdefgh")
						# ~ pass
					print(path.var)
