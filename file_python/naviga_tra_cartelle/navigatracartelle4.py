...
#ULTIMA MODIFICA.::>MODIFICO FUNZIONE COMANDO cd.. IN MODO CHE NON IL PATH NON POSSA "TORNARE INDIETRO" OLTRE A C:\(MODIFICA EFFETTUATA:-->FUNZIONA e programma non dà errore quando path .var="C:\" e inserisco cd..)
import os
def path():
