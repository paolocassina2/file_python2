...
while abc==0:		
	...
	if anagramma[0]==9 and anagramma[1]==5 and anagramma[6]==1 and anagramma1[1]==8 and anagramma1[2]==6 and anagramma1[4]==9 and anagramma1[6]==7 and anagramma2[2]==7 and anagramma2[3]==8 and anagramma2[5]==1 and anagramma2[7]==9:
