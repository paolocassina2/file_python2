...
for x1 in listapermutazioni1:
	if x1[1]==5:
		s2.append(x1)
		
for x2 in listapermutazioni1:
	if x2[3]==3:
		s3.append(x2)
		
for x3 in listapermutazioni1:
	if x3[3]==1:
		s4.append(x3)
		
for x4 in listapermutazioni1:
	if x4[4]==4:
		s5.append(x4)
		
		
for x5 in listapermutazioni1:
	if x5[0]==6:
		s6.append(x5)
				
# ~ for x in listasoluzioni:
	# ~ if x[2]==3:
		# ~ s1.append(x)
while True:#a volte scorre lista permutazioni, a volte la sceglie a caso
		# ~ if soluz2=="ok":
		# ~ soluz1=""
	for a in s1:
		a1=list(a)
