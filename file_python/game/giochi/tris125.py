#disegnare ovali,
#sistemare parte di logica del gioco (vedi anche variabili vinci)
#richiamare funzione condizione di vittoria
...
def disegna_rettangolo():
	if vinci2.var=="b":
		if posizione.var==0:
			...
			canvas1.var.create_rectangle(450+200, 250, 550+200, 350,outline="#f11", fill="#1f1", width=2)
		elif posizione.var==6:
			canvas1.var.create_rectangle(250, 450, 350, 550,outline="#f11", fill="#1f1", width=2)
		elif posizione.var==7:
			canvas1.var.create_rectangle(250+200, 450, 350+200, 550,outline="#f11", fill="#1f1", width=2)
			
		elif posizione.var==8:
			canvas1.var.create_rectangle(250+200+200, 450, 350+200+200,550,outline="#f11", fill="#1f1", width=2)
		# ~ elif posizione.var==7:
		# ~ elif posizione.var==8:
