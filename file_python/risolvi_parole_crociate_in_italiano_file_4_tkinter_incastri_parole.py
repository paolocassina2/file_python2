...
def trova_parola_incastro():
	...
	len_parola2=int(input("inserire lunghezza seconda parola"))
	lettera_in_comune=input("lettera in comune")
	print("contare da 0")
	posizione_lettera_in_comune=int(input("posizione lettera in comune"))
	p=""
